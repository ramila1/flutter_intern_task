...
import 'package:flutter_intern_task/pages/category_news.dart';
...
import 'category_not_found.dart';
...
class _HomeState extends State<Home> {
  ...
  void _handleSearch() {
    ...
    const validCategories = ["health", "business", "sports", "entertainment"];

    // Check if the query matches any of the valid categories
    if (validCategories.contains(query)) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CategoryNews(name: query),
        ),
      );
    } else {
      // Navigate to the "Category Not Found" page if the category is not found
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CategoryNotFound(),
        ),
      );
    }
  }
...
class SearchCategories extends StatelessWidget {
  ...
  SearchCategories({this.categoryName});
